...
class draw_category extends database{
 ...
 public function show_draw(){ 
    ...
    where posts.post_category='Grafika'
    ...
    if ($result->num_rows > 1) {
        ...
        echo "<br><h4 class='title'>Posts in grapich and animation category</h4>";
        echo "<div class='row'>"; 
